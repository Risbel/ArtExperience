...
export default function Home() {
  return (
    <div className="h-screen overflow-y-scroll scroll-smooth">
      <nav className="flex items-center gap-2 absolute z-[100] right-1 top-1 lg:right-20 lg:top-8 bg-[#514830]/10 backdrop-blur-sm px-2 lg:px-4 py-1 lg:py-2 rounded-3xl">
