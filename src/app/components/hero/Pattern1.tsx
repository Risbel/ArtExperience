const Pattern1 = () => {
  return (
    <div className="relative w-full h-full flex justify-center">
      <div className="absolute z-0 w-80 h-80 rotate-45 translate-y-28">
        <div className="relative w-full h-full overflow-hidden">
          <svg className="opacity-55" id="patternId" width="100%" height="100%" xmlns="http://www.w3.org/2000/svg">
            <defs>
              <pattern
                id="a"
